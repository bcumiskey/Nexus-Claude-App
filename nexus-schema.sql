...
CREATE TABLE IF NOT EXISTS models (
    id              TEXT PRIMARY KEY,          -- 'claude-sonnet-4-6' (API model string)
    label           TEXT NOT NULL,             -- 'Sonnet 4.6' (display name)
    tier            TEXT NOT NULL DEFAULT 'standard', -- 'fast', 'standard', 'apex', 'legacy'
    input_price     NUMERIC(10,4) NOT NULL,    -- $ per million input tokens
    output_price    NUMERIC(10,4) NOT NULL,    -- $ per million output tokens
